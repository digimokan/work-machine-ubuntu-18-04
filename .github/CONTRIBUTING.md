...
1. [GITHUB PAGE] Fork the project repo:
    ...
    * click "fork" from https://github.com/digimokan/work-machine-ubuntu-18-04

2. [LOCAL] Create local repo:

        $ git clone --recurse-submodules https://github.com/[your-github-username]/work-machine-ubuntu-18-04

3. [LOCAL] Link upstream repo:

        $ git remote add upstream https://github.com/digimokan/work-machine-ubuntu-18-04
